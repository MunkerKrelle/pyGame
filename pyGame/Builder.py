...
class EnemyBuilder(Builder):
    ...
    def build(self, shipType):
        ...
        if shipType == "Dreadnought":
            ...
            spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Dreadnought - Weapons.png")
        ...
        #     # spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Battlecruiser - Weapons.png")
        #     state = Battlecruiser()
        ...
        #     # spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Frigate - Weapons.png")
        #     strategy = Frigate()
        ...
        #     # spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Fighter - Weapons.png")
        #     strategy = Fighter()
        #     frame_width = 64  # Adjust based on your spritesheet
        #     frame_height = 64  # Adjust based on your spritesheet
        ...
        #     # spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Bomber - Base.png")
        #     strategy = Bomber()
        #     frame_width = 64  # Adjust based on your spritesheet
        #     frame_height = 64  # Adjust based on your spritesheet
        ...
        #     # spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Scout - Weapons.png")
        #     strategy = Scout()
        #     frame_width = 64  # Adjust based on your spritesheet
        #     frame_height = 64  # Adjust based on your spritesheet
        ...
        #     # spritesheet = (f"C:/AxP/Githubrepositories/Semester4/pyGame/Assets/EnemyShips/Weapons/pngs/Nairan - Torpedo Ship - Weapons.png")
